...
export const getRevenueHistoryApi = async (branchId, months = 6) => {
...
export const getRevenueForecastApi = async (branchId, months = 6, periods = 7) => {
...
export const getSavedRevenueForecastApi = async (branchId, months = 6, periods = 7) => {
...
export const trainRevenueForecastApi = async (branchId, months = 6) => {
