...
import { Card, Row, Col, Typography, Button, Space, Progress, Tag, Spin, Alert } from 'antd';
import {
    DollarOutlined,
    CalendarOutlined,
    CheckCircleOutlined,
...
import { getOverviewAnalyticsApi } from '../api/analyticsApi';
...
export default function OwnerDashboardPage() {
    ...
    const fetchAnalytics = useCallback(async (branchId, isManualRefresh = false) => {
    ...
    useEffect(() => {
        fetchAnalytics(selectedBranchId);
    }, [selectedBranchId, fetchAnalytics]);

    const formatVND = (amount) =>
        new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(amount || 0);

    const kpis = analytics?.kpis || {};
    const alert = analytics?.revenueAlert;
    const trendData = analytics?.last7DaysTrend || [];
    ...
    return (
        <div style={{ padding: '20px 24px', backgroundColor: '#f0f2f5', minHeight: '100vh' }}>
                ...
                <Row align="middle" justify="space-between" gutter={[16, 16]}>
                    <Col xs={24} md={14}>
                        ...
                        <Paragraph type="secondary" style={{ margin: '4px 0 0 0', fontSize: 13 }}>
                            Theo dõi chỉ số kinh doanh, lượt đặt lịch và cảnh báo doanh thu theo thời gian thực
                        </Paragraph>
                    </Col>
                    ...
                    <Col xs={24} md={10} style={{ display: 'flex', justifyContent: 'flex-end', gap: 12 }}>
                        ...
                        <Button
                            ...
                            onClick={() => fetchAnalytics(selectedBranchId, true)}
                            loading={refreshing}
            ...
            {/* Revenue Alert Banner (Bỏ nút trùng lặp, chỉ hiển thị nội dung cảnh báo) */}
