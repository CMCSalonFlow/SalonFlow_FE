...
import { Card, Table, Tag, Button, Typography, Space, Spin, message, Empty, Tabs } from "antd";
import { CalendarOutlined, PlusOutlined, ClockCircleOutlined, ShopOutlined, UserOutlined, RetweetOutlined } from "@ant-design/icons";
import { getMyBranchesApi } from "@/features/branch/api/branchApi";
import { getBookingsByBranchApi } from "../api/bookingApi";
import { RecurringBookingList } from "../recurring";
...
export default function AppointmentsPage() {
    ...
    const [branchIds, setBranchIds] = useState([]);    // dùng cho RecurringBookingList
        ...
        const loadMyBookings = async () => {
            ...
            try {
                ...
                if (branchesData && branchesData.length > 0) {
                    setBranchIds(branchesData.map(b => b.id)); // lưu để dùng cho RecurringBookingList
                ...
                <Tabs
                    ...
                    items={[
                        ...
                        },
                        {
                            ...
                            children: branchIds.length > 0 ? (
                                // Hiển thị RecurringBookingList cho từng chi nhánh khách đã đặt
